...
def draw_bounding_box_on_image(image,
  ...
  for display_str in display_str_list[::-1]:
    ...
    #draw.rectangle([(left, text_bottom - text_height - 2 * margin), (left + text_width,text_bottom)], fill=color) # Cria um retângulo para receber o texto
    draw.text((left + margin, text_bottom - text_height - margin),display_str,fill=color,font=font) # Escreve no texto a informação necessária
