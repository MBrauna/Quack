...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="apple-touch-icon" sizes="76x76" href="./Quack/img/apple-icon.png">
        <link rel="icon" type="image/png" href="./Quack/img/favicon.png">
        ...
        <link href="./Quack/demo/demo.css" rel="stylesheet" />
    </head>
    ...
    <body class="index-page">
              ...
              <li class="dropdown nav-item">
                ...
                @if (Route::has('login'))
                    <div class="dropdown-menu dropdown-with-icons">
                        @auth
                            <a class="dropdown-item" href="{{ url('/home') }}">Principal</a>
                        @else
      ...
      <div class="wrapper">
        <div class="page-header header-filter">
          ...
          <div class="container">
            <div class="content-center brand">
              <h1 class="h1-seo">Quack</h1>
              <h3>Deixe a nova geração supreender você!</h3>
            </div>
          </div>
        </div>
        <div class="main">
        ...
        <script src="./Quack/demo/demo.js"                                  type="text/javascript"></script>
